...
class Game(object):
    def __init__(self, punters_no, punters_max, port, map_name):
        self.punter_no = punters_no
        self.punters_max = punters_max
        self.port = port
        self.map_name = map_name

    def __repr__(self):
        return f"Port={self.port}, punters_max={self.punters_max}, punter_no={self.punter_no}, map_name={self.map_name}."
